...
const std::vector<int>& Tissue::cellStepDefects() const { return cell_defects[timestep]; }
const std::vector<int>& Tissue::vertexStepDefects() const { return vertex_defects[timestep]; }
